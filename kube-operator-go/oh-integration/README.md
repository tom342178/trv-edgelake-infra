...
docker build -t 100.127.19.27:5000/edgelake-operator:1.0.0 .

# Push to registry
docker push 100.127.19.27:5000/edgelake-operator:1.0.0
```
...
export OPERATOR_IMAGE=100.127.19.27:5000/edgelake-operator:1.0.0
```
...
| `EDGELAKE_LEDGER_CONN` | Master node connection | 100.127.19.27:32048 |
