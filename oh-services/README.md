...
export DOCKER_IMAGE_BASE=100.127.19.27:5000/edgelake-mcp
...
- Update `LEDGER_CONN` to point to your master node (default: 100.127.19.27:32048)
...
On the edge device (e.g., 100.91.209.39):
...
- **LEDGER_CONN**: IP:port of master node (100.127.19.27:32048)
...
2. **Edge Device Side (100.91.209.39)**:
   ```bash
   # Install OH agent (see AGENT_INSTALL.md)
   ...
   scp oh-services/operator/node.policy.json tviviano@100.91.209.39:~/
...
- Master node connection: 100.127.19.27:32048
