...
# Option B: Use curl
curl -sSL http://100.127.19.27/agent-install.sh -o agent-install.sh
chmod +x agent-install.sh
```
...
ping 100.127.19.27
curl http://100.127.19.27:3090/v1/admin/version
...
ssh tviviano@100.127.19.27 "hzn agbot status"
```
...
- [ ] Network connectivity to hub (100.127.19.27)
- [ ] Registry accessible (100.127.19.27:5000)
...
- [ ] Connection to master node verified (100.127.19.27:32048)
...
```bash
# View EdgeLake logs
docker logs -f $(docker ps -q --filter "ancestor=100.127.19.27:5000/edgelake-mcp:amd64-latest")

# Attach to EdgeLake CLI
docker attach $(docker ps -q --filter "ancestor=100.127.19.27:5000/edgelake-mcp:amd64-latest")
...
## Device Configuration for 100.91.209.39
...
curl -fsSL https://get.docker.com -o get-docker.sh
sudo sh get-docker.sh
sudo usermod -aG docker tviviano
...
cat > node-policy.json << 'EOF'
{
  "properties": [
    {"name": "purpose", "value": "edgelake"},
    {"name": "openhorizon.allowPrivileged", "value": true},
    {"name": "device-location", "value": "100.91.209.39"},
...
- EdgeLake docs: `/Users/tviviano/Documents/GitHub/documentation`
