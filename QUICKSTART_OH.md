...
Fast-track guide to deploying EdgeLake operator to device **100.91.209.39** via Open Horizon.

## Prerequisites

- OH Hub running at 100.127.19.27 with Exchange, CSS, AgBot
- EdgeLake Master node running at 100.127.19.27:32048
- Docker registry at 100.127.19.27:5000 with edgelake-mcp image
- Target device 100.91.209.39 with Docker installed
...
Still on the device (100.91.209.39):
...
abc123def456   100.127.19.27:5000/edgelake-mcp:amd64-latest       "/app/entrypoint.sh" 30 seconds ago  Up 28 seconds
```
...
CONTAINER_ID=$(docker ps -q --filter "ancestor=100.127.19.27:5000/edgelake-mcp:amd64-latest")
...
scp /path/to/oh-services/edgelake-cli.sh tviviano@100.91.209.39:~
...
# Add:
{
  "insecure-registries": ["100.127.19.27:5000"]
}
...
curl http://100.127.19.27:5000/v2/_catalog

# Test network to hub
ping 100.127.19.27
telnet 100.127.19.27 5000
```
